...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(id: $id, name: $name, phoneNumber: $phoneNumber, address1: $address1, address2: $address2, postcode: $postcode, district: $district, city: $city, state: $state, country: $country)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, phoneNumber, address1,
      address2, postcode, district, city, state, country);
