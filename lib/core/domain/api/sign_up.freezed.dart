...
class _$SignUpRequestImpl implements _SignUpRequest {
  ...
  @override
  String toString() {
    return 'SignUpRequest(username: $username, email: $email, firstName: $firstName, lastName: $lastName, password: $password)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, email, firstName, lastName, password);
